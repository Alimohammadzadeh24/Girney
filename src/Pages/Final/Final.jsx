    ...
    return (
        <div className='final-container'>
            <div className='final-header'>
                ...
                <span style={{ position: "absolute", right: "0", left: "0" , textAlign: "center"}} className='title-txts'>Final Step</span>
                <span> </span>
            </div>
            <span style={{ width: "90vw" , textAlign : "center" }} className='ch-txts'>By pressing on the butten below, you will get the link that you need to travel from london to los angles .</span>
            <div className='fly-box'>
                <div style={{ marginBottom: "16px" }} className='country-city'>
                    <span className='title-txts'>{userState.origin}</span>
                </div>
                <img style={{width : "max-content"}} src={FlyAirplane} alt="" />
